    ...
    <div class="row">
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                ...
                @foreach($d as $data)
                    <form action="/proses_editDonatur" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="position-relative form-group">
                        <label for="exampleEmail" class="">Nama</label>
                            <input name="id" type="hidden" class="form-control" value="{{$data->id}}">
                            <input name="nama" type="text" class="form-control" value="{{$data->nama_don}}">
                        </div>
                        <div class="position-relative form-group">
                        <label for="exampleEmail" class="">Email</label>
                            <input name="email" type="email" class="form-control" value='{{$data->email}}' readonly>
                        </div>
                        <div class="position-relative form-group">
                        <label for="exampleEmail" class="">Pekeraan</label>
                            <input name="pekerjaan" type="text" class="form-control" value='{{$data->pekerjaan}}'>
                        </div>
                        <div class="position-relative form-group">
                        <label for="exampleEmail" class="">Alamat</label>
                            <input name="alamat_don" type="text" class="form-control" value='{{$data->alamat_don}}'>
                        </div>
                        <div class="position-relative form-group">
                        <label for="exampleEmail" class="">No Handphone</label>
                            <input name="nohp_don" type="text" class="form-control" value='{{$data->nohp_don}}'>
                        </div>
